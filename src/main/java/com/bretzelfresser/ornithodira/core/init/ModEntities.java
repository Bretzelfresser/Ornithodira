...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<Jurvenator>> JURVENATOR = register("jurvenator", () -> EntityType.Builder.of(Jurvenator::new, MobCategory.WATER_AMBIENT).sized(0.7F, 0.5F));
    //Fish
