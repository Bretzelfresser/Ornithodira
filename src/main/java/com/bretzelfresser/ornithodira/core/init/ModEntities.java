...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<Sanchuansaurus>> SANCHUANSAURUS = register("sanchuansaurus", () -> EntityType.Builder.of(Sanchuansaurus::new, MobCategory.CREATURE).sized(1f, .6f));
