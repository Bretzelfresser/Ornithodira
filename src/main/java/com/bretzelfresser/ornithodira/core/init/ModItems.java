...
public class ModItems {
    ...
    public static final RegistryObject<ModBlockItem> FOSSILIZED_TAOHEODON_EGG = ITEMS.register("fossilized_tahoeodon_egg", () -> new ModBlockItem(ModBlocks.TAOHEODON_EGG.get(), state -> state.setValue(CustomEggBlock.FOSSILIZED, true), new Item.Properties()));
