...
public class Ornithodira {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
       if (event.getTab() == ModTabs.ITEMS.get()) {
           ...
           event.accept(ModBlocks.SHALE_STAIRS);
           event.accept(ModBlocks.SHALE_SLAB);
           event.accept(ModBlocks.SHALE_WALL);
           event.accept(ModBlocks.COBBLED_SHALE);
           event.accept(ModBlocks.COBBLED_SHALE_STAIRS);
           event.accept(ModBlocks.COBBLED_SHALE_SLAB);
           event.accept(ModBlocks.COBBLED_SHALE_WALL);
           event.accept(ModBlocks.POLISHED_SHALE);
           event.accept(ModBlocks.POLISHED_SHALE_STAIRS);
           event.accept(ModBlocks.POLISHED_SHALE_SLAB);
           event.accept(ModBlocks.POLISHED_SHALE_WALL);
           event.accept(ModBlocks.SHALE_BRICKS);
           event.accept(ModBlocks.SHALE_BRICK_STAIRS);
           event.accept(ModBlocks.SHALE_BRICK_SLAB);
           event.accept(ModBlocks.SHALE_BRICK_WALL);
           event.accept(ModBlocks.CRACKED_SHALE_BRICKS);
           event.accept(ModBlocks.MOSSY_SHALE_BRICKS);
           event.accept(ModBlocks.MOSSY_SHALE_BRICK_STAIRS);
           event.accept(ModBlocks.MOSSY_SHALE_BRICK_SLAB);
           event.accept(ModBlocks.MOSSY_SHALE_BRICK_WALL);
       }
