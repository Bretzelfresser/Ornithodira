...
public class Ornithodira {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
       if (event.getTab() == ModTabs.ITEMS.get()) {
           ...
           event.accept(ModBlocks.BROWN_SHALE);
           event.accept(ModBlocks.BROWN_SHALE_STAIRS);
           event.accept(ModBlocks.BROWN_SHALE_SLAB);
           event.accept(ModBlocks.BROWN_SHALE_WALL);
           event.accept(ModBlocks.COBBLED_BROWN_SHALE);
           event.accept(ModBlocks.COBBLED_BROWN_SHALE_STAIRS);
           event.accept(ModBlocks.COBBLED_BROWN_SHALE_SLAB);
           event.accept(ModBlocks.COBBLED_BROWN_SHALE_WALL);
           event.accept(ModBlocks.CHISELED_BROWN_SHALE);
           event.accept(ModBlocks.POLISHED_BROWN_SHALE);
           event.accept(ModBlocks.POLISHED_BROWN_SHALE_STAIRS);
           event.accept(ModBlocks.POLISHED_BROWN_SHALE_SLAB);
           event.accept(ModBlocks.POLISHED_BROWN_SHALE_WALL);
           event.accept(ModBlocks.BROWN_SHALE_BRICKS);
           event.accept(ModBlocks.BROWN_SHALE_BRICK_STAIRS);
           event.accept(ModBlocks.BROWN_SHALE_BRICK_SLAB);
           event.accept(ModBlocks.BROWN_SHALE_BRICK_WALL);
           event.accept(ModBlocks.CRACKED_BROWN_SHALE_BRICKS);
           event.accept(ModBlocks.MOSSY_BROWN_SHALE_BRICKS);
